        ...
        $.get('/offers_json').done(function( data ) {
            if (data.length == 0) {
                ...
                $.each(data, function() {
                    ...
                    $.each(this.offer_class, function(i,v) {
                         results += '<span class="text-light"> ' + v.classes.class_name + ' </span>';                   
                    });
                    results +='</div>'; // classes
                    // subjects
                    results +='<div class="col-xs-3 text-left">';
                    ...
                    results +='<span class="text-light">' + this.offer_location.name + '</span>';
                    ...
                    results +='<button type="submit" class="btn   btn-flat dropdown-toggle" data-toggle="dropdown">';
