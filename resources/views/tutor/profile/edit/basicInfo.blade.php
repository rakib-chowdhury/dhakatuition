<form action="{{ url('/tutor/profile/update/basic_info') }}" method="POST" class="form">
    {{ csrf_field() }}
    ...
    <div class="singleBlock">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control time" id="availableFrom" name="availableFrom">
                    <label for="availableFrom">Available From</label>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group timearea">
                    <input type="text" class="form-control time" id="availableTo" name="availableTo">
    ...
    <div class="singleBlock">
        ...
        <div class="checkbox checkbox-styled">
            <label>
                <input type="radio" id="noExperience" value="0" name="experience">
                <span>No</span>
            </label>
        </div>
    </div>
    ...
    <div class="singleBlock">
        ...
        <div class="checkbox checkbox-styled">
            <label>
                <input type="checkbox" id="groupTutoring" value="1" name="groupTutoring">
                <span>Group</span>
            </label>
        </div>
        ...
        <div class="checkbox checkbox-styled">
            <label>
                <input type="checkbox" value="1" name="personalTutoring" id="personalTutoring">
    ...
    <div class="singleBlock">
        ...
        <div class="">
            <div class="checkbox checkbox-styled">
                <label>
                    <input type="checkbox" value="1" name="studentHome" id="studentHome">
                    <span>Student's Home</span>
                </label>
            </div>
            <div class="checkbox checkbox-styled {{ $errors->has('yourHome') ? 'has-error' : '' }}">
                <label>
                    <input type="checkbox" value="1" name="yourHome" id="yourHome">
            ...
            <div class="checkbox checkbox-styled {{ $errors->has('online') ? 'has-error' : '' }}">
                <label>
                    <input type="checkbox" id="onlineCheckBox" value="1" name="online" id="online">
                    <span>Online</span>
                </label>
