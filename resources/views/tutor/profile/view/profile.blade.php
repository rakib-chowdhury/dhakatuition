                                ...
                                <div class="tabs-left style-default-light">
                                    ...
                                    <div class="card-body tab-content style-default-bright">
                                        <div class="tab-pane active" id="tutoring">
                                            <h2><i class="fa fa-leanpub text-primary"></i> Tutoring Information
                                                <a href="{{ url('/tutor/profile/edit') }}" class="btn pull-right btn-primary btn-xs">Edit profile</a>
                                            </h2><hr>
                                            <div id="tutoringInfo"></div>
                                        </div>
                                        <div class="tab-pane" id="education">
                                            <h2><i class="fa fa-leanpub text-primary"></i> Educational Information
                                                <a href="{{ url('/tutor/profile/edit') }}" class="btn pull-right btn-primary btn-xs">Edit profile</a>
                                            </h2><hr>
                                            <div id="educationalInfo"></div>
                                        </div>
                                        <div class="tab-pane" id="personal">
                                            <h2><i class="fa fa-file-text-o text-primary"></i> Personal Information
                                                <a href="{{ url('/tutor/profile/edit') }}" class="btn pull-right btn-primary btn-xs">Edit profile</a>
                                            </h2><hr>
                                            <div id="personalInfo"></div>
                                        </div>
                                        <div class="tab-pane" id="overView">
                                            <h2><i class="fa fa-star text-primary"></i> OverView
                                                <a href="{{ url('/tutor/profile/edit') }}" class="btn pull-right btn-primary btn-xs">Edit profile</a>
                                            </h2><hr>
