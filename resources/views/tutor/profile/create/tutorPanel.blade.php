                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-2 top_badge_picture">
                                            <img src="{{ asset('/images/avatar.png') }}" alt="profile" class="img-responsive">
                                        </div>
                                        <div class="col-sm-10 top_badge_discription">
                                            <h2>{{$tutorInfo->first_name}},{{$tutorInfo->last_name}}</h2>
                                ...
                                <article class="style-default-bright">
                                    ...
                                    <div class="tabs-left style-default-light">
                                        <ul class="card-head nav nav-tabs text-center" data-toggle="tabs">
                                            ...
                                            <li><a href="#education"><i class="fa fa-lg fa-certificate"></i><br/><h4>Education<br/><small>Educational Info</small></h4></a></li>
                                            <li><a href="#personal"><i class="fa fa-lg fa-file-text-o"></i><br/><h4>Personal<br/><small>Personal Info</small></h4></a></li>
                                            <li><a href="#overView"><i class="fa fa-lg fa-star"></i><br/><h4>Personal<br/><small>Overview</small></h4></a></li>
                                        </ul>
                                        <div class="card-body tab-content style-default-bright">
                                            <div class="tab-pane active" id="tutoring">
                                                <h2><i class="fa fa-leanpub text-primary"></i> Tutoring Information</h2><hr>
                                                @include('tutor.profile.create.tutoringBasicInfo')
                                            </div>
                                            <div class="tab-pane" id="education">
                                                <h2><i class="fa fa-leanpub text-primary"></i> Educational Information</h2><hr>
                                                @include('tutor.profile.create.tutoringEducationInfo')
                                            </div>
                                            <div class="tab-pane" id="personal">
                                                <h2><i class="fa fa-file-text-o text-primary"></i> Personal Information</h2><hr>
                                                @include('tutor.profile.create.personalInfo')
                                            </div>
                                            <div class="tab-pane" id="overView">
                                                <h2><i class="fa fa-star text-primary"></i> OverView</h2><hr>
                                                @include('tutor.profile.create.overview')
                                            </div>
                                        </div>
                                    </div>
                                    <!-- BEGIN LAYOUT OF FORM CONTENT WETH TAB -->
...
@section('specifiedJs')
    ...
    <script src="{{ asset('/js/educationalInfo.js') }}"></script>
    <script>
        $(function() {
